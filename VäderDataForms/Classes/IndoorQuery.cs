...
namespace VäderDataForms.Classes
{
    class IndoorQuery
    {
        ...
        public static List<string[]> SortWarmestDayIndoor()
        {
            using (EFContext Context = new EFContext())
            {
                var averageTemp = Context.IndoorTemperatures
                    .Where(t => t.Temperature != null)
        ...
        public static List<string[]> SortMostAridDayIndoor()
        {
            using (EFContext Context = new EFContext())
            {
                var averageHumidity = Context.IndoorTemperatures
        ...
        public static List<string[]> LowestToHighestMoldIndoor()
        {
            using (EFContext Context = new EFContext())
            {
                var averageMold = Context.IndoorTemperatures
